...
setGeneric("z11_prepare_file",
           function(file, data_location) standardGeneric("z11_prepare_file")
)

# Method: character
setMethod("z11_prepare_file",
  signature(data_location = "character"),
...
setMethod("z11_prepare_file",
  signature(data_location = "DBIConnection"),
  function(file, data_location) {
    #Read data
    message("Reading file...")
    df <- data.table::fread(file, encoding = "Latin-1")
